      ...
      <div className="bg-white rounded-lg shadow p-3 sm:p-4 md:p-6 space-y-4 sm:space-y-6">
        ...
        <div className="flex justify-end gap-3 pt-3 sm:pt-4">
          ...
          <button
            ...
            className="px-4 sm:px-6 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm"
          >
            创建抽奖
          </button>
        </div>
